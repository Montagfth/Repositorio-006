...
-- **URL base**: `http://154.38.180.218:7004/api/`
-- **Documentación OpenAPI**: Todos los endpoints y DTOs están disponibles en `http://154.38.180.218:7004/openapi/v1.json`
...
## Interfaces y DTOs
-- Todas las interfaces se crean basándose en la especificación del OpenAPI del backend (http://154.38.180.218:7004/openapi/v1.json).
